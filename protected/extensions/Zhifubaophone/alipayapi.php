...
//服务器异步通知页面路径
$notify_url = Yii::app()->request->hostInfo . "/orderpay/zhifubaook";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//页面跳转同步通知页面路径
$call_back_url = Yii::app()->request->hostInfo . "/orderpay/zhifubaouserok";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//操作中断返回地址
$merchant_url = Yii::app()->request->hostInfo . "/orderpay/zhifubaouserfail";
