					...
					<div class="cont_right_page3">
						<table cellspacing="0" cellpadding="0" >
							...
							<tr>
								...
								<td>
									<div>
										<span class="compile"><a href="/guanzhi/admin/admin_editor?id=<?php echo $value['id']; ?>&model=1"><img src="<?php echo _STATIC_ . 'vip/guanzhi/admin1/'; ?>img/icon_compile.png" /></a></span>
										<span class="del"><a href="/guanzhi/admin/admin_delete?id=<?php echo $value['id'];?>&model=1"><img src="<?php echo _STATIC_ . 'vip/guanzhi/admin1/'; ?>img/icon_error.png" /></a></span>
									</div>
								</td>
							</tr>
                                                        <?php endforeach; ?>
