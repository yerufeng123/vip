...
<div id="wrap" class="mp_web" data-move>
    ...
    <div class="jp_main">
        <div class="jp_tu_main jp_pay_main">
              ...
              <p class="pay_tit1">恭喜您以秒拍价格购得</p>
              <p class="pay_tit2"><?php echo $goods['setting']['name']?></p>
              <div class="pay_price mp_pay_price">
                  <p>秒拍产品数量：<span><?php echo $goods['setting']['sale_num']?></span> 个</p>
                  <p>秒拍价格：<span><?php echo $goods['setting']['price']?></span> 元</p>
              </div>

             
        </div>
    </div>
    <span class="jp_enter mp_btn"><a href='<?php echo $this->createUrl('active/certificate_web',array('cid'=>$cid,'type'=>Constant::CHANNEL_SECKILL));?>'>领取秒拍凭证</a></span>
    <div class="jp_bt"></div>
</div>
