    ...
    <div class="jp_main">
        <div class="jp_tu_main jp_tu_main_er">
            <div class="jp_tu_ps">
                ...
                <h4 class="er_tit">竞拍凭证</h4>
                <p class="er_tit2">恭喜您以竞拍价购得 <?php echo $goods['setting']['name']?>。</p>
                
            </div>
        </div>
        <p class="er_detail">您已支付成功，请保存二维码页面，或在“斯特拉斯堡圣诞集市”公众号管理凭证，到蓝色港湾  <?php echo $shop_num;?> 木屋处兑换商品。</p>
    </div>
    <span class="jp_enter jp_btn"><a href='<?php echo $this->createUrl('active/my_certificate',array('type'=>1,'atype'=>Constant::CHANNEL_AUCTION));?>'>竞拍凭证管理</a></span>
    <div class="jp_bt"></div>
</div>
