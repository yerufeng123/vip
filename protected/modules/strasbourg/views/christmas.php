...
<link type="text/css" href="<?php echo _STATIC_ . 'vip/strasbourg/'; ?>css/game.css" rel="stylesheet">
</head>
<body>
		...
		<ul id="page_list">
			...
			<section id="mask" style="display: none">
				...
				<section class="dialog first_place" id="false" style="display: none">
					...
					<a href="javascript:void(0)" class="result_btn">查看游戏结果</a>
				</section>
				<!-- 游戏弹出窗 -->
...
<script>
      ...
      $('.result_btn').click(function(){
         ...
         $.post('<?php echo $this->createUrl('active/gamereg');?>',{name:name,phone:phone,home:home},function(data){
             console.log(data);
            if(data.code == 1000){
              	setscore(2);
            }else{
