  ...
  <div class="mask_main mask_yx_main hx_login">
    <a href="javascript:void(0)" class="close_btn"></a>
      <div class="mask_one mask_login">
          <h3>尊敬的商家您好，请填写您的手机号和商户编号，该手机将用于本次活动用户礼品码的核销。</h3>
...
//  	   	 }
  ...
  $('#sub_btn').bind('click',function(){
	    ...
	    if(person.checkInput()){
	       $.post('/strasbourg/register/bregister',{'roomnumer':person.roomnumer,'phone':person.phone},function(data){
	    	   var list=eval('('+data+')');
	    	   if(list.code != '10000'){
	                alert(list.result);
	            }else{
