...
<div class="mask_diag" data-move  style="display:;" >
  <div class="mask_main mask_yx_main">
    <img src="<?php echo _STATIC_?>vip/strasbourg/img/yx_tit.png" class="yx_tit">
      <div class="mask_one mask_yx_one">
          <img src="/<?php echo $certificate->erweimaurl;?>" class="er_img">
          <h3>请凭此码在现场<br/>兑换礼品&优惠</h3>
          <a href="http://mp.weixin.qq.com/s?__biz=MzAwODcyNzQ0OA==&mid=400101983&idx=1&sn=5783012ad3f94b57195a18e38a2d8dea&scene=1&srcid=1029GPxnSFMJm7NyqgVwLz6J&from=singlemessage&isappinstalled=0#wechat_redirect" class="diag_btn">关注圣诞集市</a>
      </div>
  </div>
</div>
