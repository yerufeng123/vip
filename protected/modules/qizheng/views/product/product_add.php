...
<div class="Tc_input">
    <form id="myForm" name="myForm"  enctype="multipart/form-data">
        <div style="margin:auto;width: 600px;border: 10px solid #ffffff;">
            ...
            产品名称:<input type="text" name="name" value="" class="input25" maxlength="100"/><font color="red">*必填</font><br/>
            适&ensp;用&ensp;证:<textarea name="introduction" class="textarea100"></textarea><font color="red">*必填</font><br />
            用法用量:<textarea name="use_method" class="textarea100"></textarea><font color="red">*必填</font><br />
            不良反应:<textarea name="bad_reaction" class="textarea100"></textarea><font color="red">*必填</font><br />
            产品禁忌:<textarea name="taboo" class="textarea100"></textarea><font color="red">*必填</font><br />
            <div class="clearbar10"></div>
            <div id="newinfo_box"></div>
            <div class="clearbar10"></div>
            ...
            <div id="tu_photo2"></div><br />
            <input type="hidden" name="pic" id="pic" value=""/>
            <input type="hidden" name="product_pic" id="product_pic" value=""/>
        ...
        <div class="clearbar10"></div>
        <input type='hidden' id='controlPath' value='/qizheng/product/product_add'/>
        <input type='hidden' id='displayPath' value='/qizheng/product/index?model=2'/>
    </form>
</div>
