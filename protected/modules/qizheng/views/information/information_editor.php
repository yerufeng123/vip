...
<div class="Tc_input">
    <form id="myForm" name="myForm"  enctype="multipart/form-data">
        <div style="margin:auto;width: 600px;border: 10px solid #ffffff;">
            ...
            分类标题:<input type="text" name="title" value="<?php echo $list['title'] ?>" class="input25" maxlength="50"/><font color="red">*必填</font><br/>
            所属产品:<select name="pid" class="select25" id="pid">
                <option value="" >请选择产品</option>    
            </select><font color="red">*必填</font><br />
            <input type="hidden" id="pid2" value="<?php echo $list['pid'] ?>">
            产品排序:<input type="text" name="PX" value="<?php echo $list['PX'] ?>" class="input25"/><font color="green">*选填</font><br/>

            是否显示：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="display"  <?php
            if ($list['display'] == '0') {
                echo 'checked';
            }
            ?>  value="0"/>否&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="display" <?php
                                                                                    if ($list['display'] == '1') {
                                                                                        echo 'checked';
                                                                                    }
                                                                                    ?> value="1"/>是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/>
            ...
            <div class="clearbar10"></div>
            分类小图:<font color="red">*必填(140*110)</font><input id="file_upload1"  type="file" multiple="true">
            <div id="tu_photo1">
                <?php
        ...
        <div class="clearbar10"></div>
        <input type='hidden' id='controlPath' value='/qizheng/information/information_editor'/>
    </form>
</div>
