...
<div class="Tc_input">
    <form id="myForm" name="myForm"  enctype="multipart/form-data">
        <div style="margin:auto;width: 600px;border: 10px solid #ffffff;">
            ...
            分类标题:<input type="text" name="title" value="" class="input25" maxlength="50"/><font color="red">*必填</font><br/>
        ...
        <div class="clearbar10"></div>
        <input type='hidden' id='controlPath' value='/qizheng/information/information_add'/>
        <input type='hidden' id='displayPath' value='/qizheng/information/index?model=3'/>
    </form>
</div>
