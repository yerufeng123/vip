...
<div class="cont_right">
    <div class="cont_right_page1">
        <span><img src="<?php echo _STATIC_ . 'vip/qizheng/admin1/'; ?>img/icon_place.png" />您当前位置：<span>推广管理</span></span>
    </div>
    <div class="cont_right_page2">
        <form action="/qizheng/link/index?model=4" method="POST">
                        所属产品:<select name="pid" style="width:150px;text-align: center;" id="pid">
                            <option value="" >请选择产品</option>    
                        </select>
                        链接标题:<input type="text" name="title" value="<?php echo $search['title']; ?>">
        ...
        <table  cellspacing="0" cellpadding="0" >
            ...
            <?php if (isset($list) && is_array($list)): ?>
                ...
                echo $value['title'];
                        ...
                        <td><?php if (mb_strlen($value['url'], 'utf-8') > 40) {
                echo msubstr($value['url'], 0, 40);
            } else {
                echo $value['url'];
            } ?></td>
                        <td><?php if ($value['display'] == 0) {
                ...
                echo '<font color="green">显示</font>';
                        ...
                        <td>
                            <div>
                                <span class="compile"><a href="/qizheng/link/link_editor?id=<?php echo $value['id']; ?>&model=4"><img src="<?php echo _STATIC_ . 'vip/qizheng/admin1/'; ?>img/icon_compile.png" /></a></span>
                                <span class="del"><a href="/qizheng/link/link_delete?id=<?php echo $value['id']; ?>&model=4"><img src="<?php echo _STATIC_ . 'vip/qizheng/admin1/'; ?>img/icon_error.png" /></a></span>
                            </div>
                        </td>
                    </tr>
    <?php endforeach; ?>
