...
<div class="Tc_input">
    <form id="myForm" name="myForm"  enctype="multipart/form-data">
        <div style="margin:auto;width: 600px;border: 10px solid #ffffff;">
            ...
            链接标题:<input type="text" name="title" value="" class="input25" maxlength="125"/><font color="red">*必填</font><br/>
            所属产品:<select name="pid" class="select25" id="pid" onclick="levelchange(this)">
                <option value="" >请选择产品</option>    
            </select><font color="red">*必填</font><br />
            相关链接:<textarea name="url" class="textarea100" id="urlvalue"></textarea><font color="red">*必填</font><br />

            <div class="clearbar10"></div>
            链接小图:<font color="red">*必填(140*110)</font><input id="file_upload1"  type="file" multiple="true">
        ...
        <div class="clearbar10"></div>
        <input type='hidden' id='controlPath' value='/qizheng/link/link_add'/>
        <input type='hidden' id='displayPath' value='/qizheng/link/index?model=4'/>
    </form>
</div>
