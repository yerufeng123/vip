...
<body>
    <div id="wrap" class="page1">
        <img class="login_img" src="<?php echo _STATIC_ . 'vip/qizheng/'; ?>img/img9.png" />
    ...
    <div class="mask">
        <div class="mask_pro">
            <img class="close" src="<?php echo _STATIC_ . 'vip/qizheng/'; ?>img/error.png" />
...
<script>
    function tijiao() {
        ...
        $.post('/qizheng/login/userloginon', {'usercode': usercode}, function(data) {
            if (data != '') {
                $('.mask').show();
                $('#maskcontent').html(data);
            } else {
                window.location.href = "/qizheng/index/index";
            }
