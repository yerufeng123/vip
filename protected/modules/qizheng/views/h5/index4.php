  ...
  <body> 
  	<div id="wrap" >
  		<ul id="page_list" stage="">
  			<li class="page show page7" id="" scene="1" stop-move="-1">
  				<div class="photo"></div>
  			</li>
  			<li class="page page8" id="" scene="2">
  				<div class="photo"></div>
  			</li>
  			<li class="page page9" id="" scene="3">
  				<div class="photo"></div>
  			</li>
  			<li class="page page10" id="" scene="4">
  				<div class="photo"></div>
  			</li>
  			<li class="page page11" id="" scene="5" stop-move="1">
  				<div class="photo"></div>
  			</li>
  		</ul>
