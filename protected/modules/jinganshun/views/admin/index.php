...
<div class="cont_right">
					<div class="cont_right_page1">
						<span><img src="<?php echo _STATIC_ . 'vip/jinganshun/admin1/'; ?>img/icon_place.png" />您当前位置：<span>管理员管理</span></span>
					</div>
					<div class="cont_right_page2">
						<form action="/jinganshun/admin/admin_add?model=1" method="POST">
					...
					<div class="cont_right_page3">
						<table cellspacing="0" cellpadding="0" >
							...
							<tr>
								...
								<td>
									<div>
										<span class="compile"><a href="/jinganshun/admin/admin_editor?id=<?php echo $value['id']; ?>&model=1"><img src="<?php echo _STATIC_ . 'vip/jinganshun/admin1/'; ?>img/icon_compile.png" /></a></span>
										<span class="del"><a href="/jinganshun/admin/admin_delete?id=<?php echo $value['id'];?>&model=1"><img src="<?php echo _STATIC_ . 'vip/jinganshun/admin1/'; ?>img/icon_error.png" /></a></span>
									</div>
								</td>
							</tr>
                                                        <?php endforeach; ?>
