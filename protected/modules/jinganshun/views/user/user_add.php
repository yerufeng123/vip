...
<div class="Tc_input">
    <form id="myForm" name="myForm"  enctype="multipart/form-data">
        <div style="margin:auto;width: 600px;border: 10px solid #ffffff;">
            ...
            <span style="font-family: '宋体', Simsun;" mce_style="font-family: '宋体', Simsun;">上班时间:</span><input type="text" name="starttime" class="input25" id="starttime" maxlength="11" value="09:00:00"/><font color="green">*选填</font><br />
            <span style="font-family: '宋体', Simsun;" mce_style="font-family: '宋体', Simsun;">下班时间:</span><input type="text" name="endtime" class="input25" id="endtime" maxlength="11" value="18:00:00"/><font color="green">*选填</font><br />
            <div class="clearbar10"></div>
        </div>
        <div class="clearbar10"></div>
        <center>
        ...
        <div class="clearbar10"></div>
        <input type='hidden' id='controlPath' value='/jinganshun/user/user_add'/>
        <input type='hidden' id='displayPath' value='/jinganshun/user/index?model=1'/>
    </form>
</div>
