...
<div class="Tc_input">
    <form id="myForm" name="myForm"  enctype="multipart/form-data">
        <div style="margin:auto;width: 600px;border: 10px solid #ffffff;">
            ...
            <input type="hidden" name="pic" id="pic" value="<?php echo $data['content'] ?>"/>
            <input type="hidden" name="pic_bk" id="pic_bk" value="<?php echo $data['content'] ?>"/>
        ...
        <div class="clearbar10"></div>
        <input type='hidden' id='controlPath' value='/jinganshun/recruit/pics'/>
    </form>
</div>
