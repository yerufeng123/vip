...
<div class="Tc_input">
    <form id="myForm" name="myForm"  enctype="multipart/form-data">
        <div style="margin:auto;width: 600px;border: 10px solid #ffffff;">
            ...
            名称:<input type="text" name="title" value="<?php echo $list['title'] ?>" class="input25" maxlength="125"/><font color="red">*必填</font><br/>
            <div class="clearbar10"></div>
        ...
        <div class="clearbar10"></div>
        <input type='hidden' id='controlPath' value='/jinganshun/recruit/modeloneeditor'/>
