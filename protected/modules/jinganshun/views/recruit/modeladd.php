...
<div class="Tc_input">
    <form id="myForm" name="myForm"  enctype="multipart/form-data">
        ...
        <div class="clearbar10"></div>
        <input type='hidden' id='controlPath' value='/jinganshun/recruit/modeladd'/>
        <input type='hidden' id='displayPath' value='/jinganshun/recruit/modelone?model=3&type=<?php echo $_GET['type']?>'/>
    </form>
</div>
