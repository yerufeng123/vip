...
height="1" width="1" border="0" alt="" />
	...
	<body>
		<div class="page page_0" id="page_0" data-destination="#page_3_1">
			&nbsp;
		</div>
		<div class="page page_3_1" id="page_3_1">
			<img class="page_3_1_main" src="<?php echo _STATIC_;?>vip/guohang/img/page_3_1_main.png" />
			<div class="page_3_1_heart">
				<img src="<?php echo _STATIC_;?>vip/guohang/img/heart_1.png" />
				<img src="<?php echo _STATIC_;?>vip/guohang/img/heart_2.png" />
				<img src="<?php echo _STATIC_;?>vip/guohang/img/heart_1.png" />
				<img src="<?php echo _STATIC_;?>vip/guohang/img/heart_2.png" />
				<img src="<?php echo _STATIC_;?>vip/guohang/img/heart_1.png" />
				<img src="<?php echo _STATIC_;?>vip/guohang/img/heart_2.png" />
			...
			<textarea class="page_3_1_text" id="content" >幸福如此简单，如此平凡。只因牵起你的手不曾放开。未来远在天涯，近在咫尺。我愿用走遍世界的足迹来说：我爱你！
（以上祝福语不足以表达你的心情？删掉它们，说出你的心里话！）</textarea>
			<input class="page_3_1_input" type="text" name="" id="name" value="" placeholder="署名" />
			<div class="page_3_1_btn_box">
