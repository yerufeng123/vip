...
height="1" width="1" border="0" alt="" />
	...
	<body>
		<div class="page page_0" id="page_0" data-destination="#page_3_2">
			&nbsp;
		</div>
		<div class="page page_3_2" id="page_3_2">
			<img class="page_3_2_main" src="<?php echo _STATIC_;?>vip/guohang/img/page_3_2_main.png" />
			<textarea class="page_3_2_text" id="content">我想和你走遍每一条古老的街道，也想和你一起穿过茂密的丛林，更想和你纵情于山水！
2016年愿我们生活的每一天都不再单调，肆意豁达，初心不老。（以上祝福语不足以表达你的心情？删掉它们，说出你的心里话！）</textarea>
			<input class="page_3_2_input" type="text" name="" id="name" value="" placeholder="署名" />
			<img class="page_3_2_ballon" src="<?php echo _STATIC_;?>vip/guohang/img/page_3_2_ballon.png" />
			<img class="page_3_2_rainbow" src="<?php echo _STATIC_;?>vip/guohang/img/page_3_2_rainbow.png" />
			<img class="page_3_2_kite" src="<?php echo _STATIC_;?>vip/guohang/img/page_3_2_kite.png" />
			<div class="page_3_2_btn_box">
