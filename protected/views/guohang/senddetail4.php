...
height="1" width="1" border="0" alt="" />
	...
	<body>
		<div class="page page_0" id="page_0" data-destination="#page_3_4">
			&nbsp;
		</div>
		<div class="page page_3_4" id="page_3_4">
			<img class="page_3_4_main" src="<?php echo _STATIC_;?>vip/guohang/img/page_3_4_main.jpg" />
			<img class="page_3_4_flower" src="<?php echo _STATIC_;?>vip/guohang/img/page_3_4_flower.png" />
			<textarea class="page_3_4_text" id="content">感谢您总能在我最难的时刻站在我的身边，在我需要帮助的时候伸出援手。
再多感谢的语言都显得如此苍白，只愿你和你爱的人都一切安好。
（以上祝福语不足以表达你的心情？删掉它们，说出你的心里话！）</textarea>
			<input class="page_3_4_input" type="text" name="" id="name" value="" placeholder="署名" />
			<div class="page_3_4_btn_box">
