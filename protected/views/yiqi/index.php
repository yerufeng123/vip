...
<html lang="zh-cn">
    ...
    <body>
        <form action="/yiqi/useradd" method="post" id="myform" >
            <div id="wrap" style='max-width: 322px;margin:auto'>
                ...
                <h6>感受极致天使魅惑</h6>
                <p>天使面庞、魔鬼身材，展现极致妖娆魅惑，REIZ Angel惊艳亮相这场魅力十足的盛宴。</p>
                ...
                <ul class="uls uls1">
                    <li>
                        <label>具体活动时间：</label><input type="text" name="business"/>
                    </li>
                    <li>
                        <label>具体活动地点：</label><input type="text" name="address2"/>
                    </li>
                </ul>
                <h6>报名方式：</h6>
                ...
                <ul class="uls uls2">
                    <li>
                        <label>当地经销店地址：</label><input type="text" name="address1" />
                    </li>
                    <li>
                        <label>联系电话：</label><input type="text" name="phone"/>
                    </li>
                    <li>
                        <label>微信公众账号：</label><input type="text" name="weixin"/>
                    </li>
                </ul>
                <img class="img7" src="<?php echo _STATIC_ ?>vip/yiqi/img/img7.jpg" /><p class="wechat_change">微信互动</p>
                <a href="javascript:viod(0)" class="sub_btn" id="sub_btn">提交</a>
