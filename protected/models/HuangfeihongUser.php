...
/**
 * This is the model class for table "{{huangfeihong_user}}".
 *
 * The followings are the available columns in table '{{huangfeihong_user}}':
 * @property integer $id
 ...
 */
class HuangfeihongUser extends CActiveRecord
{
	/**
	 ...
	 * @return HuangfeihongUser the static model class
	 */
